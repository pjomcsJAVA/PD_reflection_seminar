...
/**
 * This class holds all {@link FactoryAnnotatedClass}s that belongs to one factory.
 * This class also checks if the id of each @Factory annotated class is unique.
 *
 */
